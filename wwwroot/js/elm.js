...
var author$project$Main$GotNewVotingMsg = function (a) {
	return {$: 4, a: a};
};
var author$project$Main$GotVotingMsg = function (a) {
	return {$: 3, a: a};
};
var author$project$Main$Home = function (a) {
	return {$: 2, a: a};
};
var author$project$Main$NewVoting = function (a) {
	return {$: 4, a: a};
};
var author$project$Main$NotFound = function (a) {
	return {$: 1, a: a};
};
var author$project$Main$Voting = function (a) {
	return {$: 3, a: a};
};
...
var author$project$Main$toSession = function (page) {
	switch (page.$) {
		...
		case 3:
			var voting = page.a;
			return author$project$Page$Voting$toSession(voting);
		default:
			var newVoting = page.a;
			return author$project$Page$NewVoting$toSession(newVoting);
	}
};
...
var author$project$Page$Home$init = function (session) {
	return _Utils_Tuple2(
		A3(author$project$Page$Home$Model, session, '', ''),
...
var author$project$Page$NewVoting$init = function (session) {
	return _Utils_Tuple2(
		A4(
			author$project$Page$NewVoting$Model,
			session,
			'',
			_List_fromArray(
				[
					A2(author$project$Page$NewVoting$Variant, 1, ''),
					A2(author$project$Page$NewVoting$Variant, 2, '')
				]),
			''),
		elm$core$Platform$Cmd$none);
};
...
var author$project$Page$Voting$init = F2(
	function (session, votingId) {
		var user = author$project$Component$User$init('');
		return _Utils_Tuple2(
			A7(author$project$Page$Voting$Model, session, '', '', _List_Nil, _List_Nil, user, false),
			author$project$Api$toJs(
				elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'action',
							elm$json$Json$Encode$string('GetExistingVoting')),
							_Utils_Tuple2(
							'votingId',
							elm$json$Json$Encode$string(votingId))
						]))));
	});
		...
		if (maybeRoute.$ === 1) {
			...
			switch (maybeRoute.a.$) {
				...
				case 1:
					...
					return A4(
						author$project$Main$updateWith,
						author$project$Main$Voting,
						author$project$Main$GotVotingMsg,
						model,
						A2(author$project$Page$Voting$init, session, id));
				default:
					var _n2 = maybeRoute.a;
					return A4(
						author$project$Main$updateWith,
						author$project$Main$NewVoting,
						author$project$Main$GotNewVotingMsg,
						model,
						author$project$Page$NewVoting$init(session));
			}
		}
	});
var author$project$Route$Home = {$: 0};
var author$project$Route$NewVoting = {$: 2};
var author$project$Route$Voting = function (a) {
	return {$: 1, a: a};
};
...
var author$project$Route$routeParser = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			author$project$Route$Voting,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s('vote'),
				elm$url$Url$Parser$string)),
			A2(
			elm$url$Url$Parser$map,
			author$project$Route$NewVoting,
...
var author$project$Route$fromUrl = function (url) {
	return A2(elm$url$Url$Parser$parse, author$project$Route$routeParser, url);
};
	...
	function (flags, url, key) {
		return A2(
			...
			author$project$Main$Redirect(
				author$project$Session$init(key)));
	});
var elm$json$Json$Decode$value = _Json_decodeValue;
var author$project$Api$toElm = _Platform_incomingPort('toElm', elm$json$Json$Decode$value);
var author$project$Page$Home$VotingCheckResult = function (a) {
	return {$: 2, a: a};
};
var elm$json$Json$Decode$decodeValue = _Json_run;
var elm$json$Json$Decode$field = _Json_decodeField;
var elm$json$Json$Decode$string = _Json_decodeString;
var author$project$Page$Home$decodeVotingId = function (x) {
	var votingIdDecoder = A2(elm$json$Json$Decode$field, 'votingId', elm$json$Json$Decode$string);
	var result = A2(elm$json$Json$Decode$decodeValue, votingIdDecoder, x);
	if (!result.$) {
		var string = result.a;
		return author$project$Page$Home$VotingCheckResult(
			elm$core$Maybe$Just(string));
	} else {
		return author$project$Page$Home$VotingCheckResult(elm$core$Maybe$Nothing);
	}
};
var author$project$Page$Home$subscriptions = function (model) {
	return author$project$Api$toElm(author$project$Page$Home$decodeVotingId);
};
var author$project$Page$NewVoting$VotingSubmitted = function (a) {
	return {$: 5, a: a};
};
var author$project$Page$NewVoting$decodeVotingId = function (x) {
	var votingIdDecoder = A2(elm$json$Json$Decode$field, 'votingId', elm$json$Json$Decode$string);
	var result = A2(elm$json$Json$Decode$decodeValue, votingIdDecoder, x);
	if (!result.$) {
		var string = result.a;
		return author$project$Page$NewVoting$VotingSubmitted(
			elm$core$Maybe$Just(string));
	} else {
		return author$project$Page$NewVoting$VotingSubmitted(elm$core$Maybe$Nothing);
	}
};
var author$project$Page$NewVoting$subscriptions = function (model) {
	return author$project$Api$toElm(author$project$Page$NewVoting$decodeVotingId);
};
...
var author$project$Page$Voting$decodeVoting = F2(
	function (model, x) {
		var variantDecoder = A3(
			elm$json$Json$Decode$map2,
			author$project$Page$Voting$Variant,
			A2(elm$json$Json$Decode$field, 'Id', elm$json$Json$Decode$int),
			A2(elm$json$Json$Decode$field, 'Text', elm$json$Json$Decode$string));
		var answersDecoder = A3(
			elm$json$Json$Decode$map2,
			author$project$Page$Voting$UserAnswer,
			A2(elm$json$Json$Decode$field, 'VariantId', elm$json$Json$Decode$int),
		...
		var votingDecoder = A8(
			...
			A2(
				...
				'Variants',
				elm$json$Json$Decode$list(variantDecoder)),
			A2(
				elm$json$Json$Decode$field,
				'Answers',
		...
		if (!result.$) {
			var voting = result.a;
			return author$project$Page$Voting$VotingLoaded(
				elm$core$Maybe$Just(voting));
		} else {
			var err = result.a;
			return author$project$Page$Voting$VotingLoaded(elm$core$Maybe$Nothing);
		}
	});
var author$project$Page$Voting$subscriptions = function (model) {
	return author$project$Api$toElm(
		author$project$Page$Voting$decodeVoting(model));
};
...
var author$project$Main$subscriptions = function (model) {
	switch (model.$) {
		...
		case 4:
			var newVotingModel = model.a;
			return A2(
				elm$core$Platform$Sub$map,
				author$project$Main$GotNewVotingMsg,
				author$project$Page$NewVoting$subscriptions(newVotingModel));
		case 3:
			var votingModel = model.a;
			return A2(
				elm$core$Platform$Sub$map,
				author$project$Main$GotVotingMsg,
				author$project$Page$Voting$subscriptions(votingModel));
		default:
...
var author$project$Route$goToUrl = F2(
	function (key, route) {
		return A2(
...
var author$project$Page$NewVoting$addNewVariant = function (model) {
	var existing = model.g;
	var newId = function () {
	...
	var newVariant = A2(author$project$Page$NewVoting$Variant, newId, '');
	return _Utils_ap(
		existing,
		_List_fromArray(
			[newVariant]));
};
var author$project$Page$NewVoting$updateVariant = F3(
...
var author$project$Page$NewVoting$changeVariant = F3(
	function (v, updatedText, model) {
		return A2(
			elm$core$List$map,
			A2(author$project$Page$NewVoting$updateVariant, v, updatedText),
			model.g);
	});
var author$project$Session$Creator = 1;
...
var author$project$Page$NewVoting$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							g: author$project$Page$NewVoting$addNewVariant(model)
						}),
					elm$core$Platform$Cmd$none);
			case 1:
				var v = msg.a;
				var updatedText = msg.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							g: A3(author$project$Page$NewVoting$changeVariant, v, updatedText, model)
						}),
					elm$core$Platform$Cmd$none);
			case 2:
				var v = msg.a;
					...
					_Utils_update(
						model,
						{
							g: A2(
								...
								function (s) {
									return !_Utils_eq(v.aM, s.aM);
								},
								model.g)
						}),
					elm$core$Platform$Cmd$none);
			case 3:
				var questionText = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{D: questionText}),
...
var author$project$Component$User$update = F2(
	function (msg, model) {
		var name = msg;
		return _Utils_Tuple2(
			_Utils_update(
...
var author$project$Page$Voting$updateWith = F4(
	function (toModel, toMsg, model, _n0) {
		var subModel = _n0.a;
		var subCmd = _n0.b;
		return _Utils_Tuple2(
...
var author$project$Page$Voting$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var subMsg = msg.a;
				return A4(
					author$project$Page$Voting$updateWith,
					function (subMod) {
						return _Utils_update(
							model,
							{n: subMod});
			...
			case 1:
				...
				if (!result.$) {
					var voting = result.a;
					return _Utils_Tuple2(voting, elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						model,
						A2(
						...
						elm$json$Json$Encode$object(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'action',
									elm$json$Json$Encode$string('SubmitVoteVariant')),
									_Utils_Tuple2(
									'votingId',
						...
						elm$json$Json$Encode$object(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'action',
									elm$json$Json$Encode$string('CloseVoting')),
									_Utils_Tuple2(
									'votingId',
									elm$json$Json$Encode$string(model.aM))
								]))));
				...
				case 3:
					if (_n0.b.$ === 3) {
						...
						return A4(
							...
							author$project$Main$GotVotingMsg,
							model,
							A2(author$project$Page$Voting$update, subMsg, voting));
					} else {
						break _n0$6;
					}
				case 4:
					if (_n0.b.$ === 4) {
						var subMsg = _n0.a.a;
						var newVoting = _n0.b.a;
						return A4(
							author$project$Main$updateWith,
							author$project$Main$NewVoting,
							author$project$Main$GotNewVotingMsg,
							model,
							A2(author$project$Page$NewVoting$update, subMsg, newVoting));
					} else {
						break _n0$6;
					}
				default:
...
var author$project$Main$footerElement = _List_fromArray(
	[
		...
		_List_fromArray(
			[
				elm$html$Html$text('Server is not saving votings and doesn\'t have persistant storage. All results can be lost in any time. Save results by yourself!')
			])),
		A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									elm$html$Html$Attributes$class('nav-link' + mainPageClass)
								]),
							_List_fromArray(
								[
...
var author$project$Page$Home$ChangeSeachVotingValue = function (a) {
	return {$: 0, a: a};
};
var author$project$Page$Home$CheckVoting = {$: 1};
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text('Please create or join voting!')
						])),
					A2(
					elm$html$Html$p,
					_List_fromArray(
					...
					_List_fromArray(
						[
							elm$html$Html$text('Quick, fast, realtime voting in just few clicks. Create voting and share link with colleagues. See results immediately!')
						])),
					A2(
					elm$html$Html$hr,
					_List_fromArray(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$text('Create new voting')
										]))
								])),
							A2(
							elm$html$Html$div,
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															elm$html$Html$text('Insert identifier of existing voting:')
														])),
													A2(
													elm$html$Html$input,
													_List_fromArray(
											...
											_List_fromArray(
												[
													...
													elm$html$Html$Attributes$value('Find voting'),
													elm$html$Html$Events$onClick(author$project$Page$Home$CheckVoting)
												]),
											_List_Nil)
										]))
								]))
...
var author$project$Page$NewVoting$AddNewVariant = {$: 0};
var author$project$Page$NewVoting$ChangeQuestion = function (a) {
	return {$: 3, a: a};
};
var author$project$Page$NewVoting$SubmitVoting = {$: 4};
...
var author$project$Page$NewVoting$showCreateVoteButton = function (model) {
	return ((model.D !== '') && ((elm$core$List$length(model.g) > 1) && A2(
		...
		[
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('btn btn-success ml-1 mt-2'),
					elm$html$Html$Attributes$type_('button'),
					elm$html$Html$Attributes$value('Create vote'),
					elm$html$Html$Events$onClick(author$project$Page$NewVoting$SubmitVoting)
				]),
			_List_Nil)
		]) : _List_Nil;
};
var author$project$Page$NewVoting$ChangeVariant = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
var author$project$Page$NewVoting$RemoveVariant = function (a) {
	return {$: 2, a: a};
};
var elm$html$Html$Attributes$placeholder = elm$html$Html$Attributes$stringProperty('placeholder');
var author$project$Page$NewVoting$viewVariant = F3(
	function (model, ind, v) {
		var strIndex = elm$core$String$fromInt(ind + 1);
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('form-row mt-1')
				]),
			_List_fromArray(
				[
					A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									elm$html$Html$Attributes$type_('button'),
									elm$html$Html$Attributes$value('Remove variant'),
									elm$html$Html$Events$onClick(
									author$project$Page$NewVoting$RemoveVariant(v))
								]),
							_List_Nil)
						]))
				]));
...
var author$project$Page$NewVoting$view = function (model) {
	var form = _Utils_ap(
		_List_fromArray(
			[
				A2(
		...
		_Utils_ap(
			A2(
				...
				author$project$Page$NewVoting$viewVariant(model),
				model.g),
			_Utils_ap(
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('btn btn-primary mt-2'),
								elm$html$Html$Attributes$type_('button'),
								elm$html$Html$Events$onClick(author$project$Page$NewVoting$AddNewVariant),
								elm$html$Html$Attributes$value('Add new variant')
							]),
						_List_Nil)
					]),
				author$project$Page$NewVoting$showCreateVoteButton(model))));
	return _List_fromArray(
		[
			A2(
			elm$html$Html$h2,
...
var author$project$Page$Voting$showClose = function (model) {
	return (author$project$Session$isCreator(model.E) && (!model.B)) ? _List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('btn btn-danger mt-2'),
					elm$html$Html$Attributes$type_('button'),
					elm$html$Html$Attributes$value('Close voting'),
					elm$html$Html$Events$onClick(author$project$Page$Voting$CloseVoting)
				]),
			_List_Nil)
		]) : _List_Nil;
};
var author$project$Page$Voting$showRole = function (model) {
	return model.B ? _List_fromArray(
		...
		[
			...
			_List_fromArray(
				[
					elm$html$Html$text('You are creator. Don\'t reload the page. Otherwise the voting will be closed and read-only.')
				]))
		]) : _List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('alert alert-dark')
				]),
			_List_fromArray(
				[
					elm$html$Html$text('You are voter.')
				]))
		]));
};
...
var author$project$Component$User$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('form-text text-danger'),
								elm$html$Html$Attributes$hidden(
								!author$project$Component$User$emptyName(model))
							]),
						_List_fromArray(
							[
								elm$html$Html$text('Please provide your name')
							]))
					]))
			]));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Attributes$type_('button'),
						elm$html$Html$Attributes$value('Vote!'),
						elm$html$Html$Events$onClick(
						author$project$Page$Voting$SubmitVoteVariant(variant))
					]),
				_List_Nil)
			]);
	});
var author$project$Page$Voting$votesCount = F2(
	...
	function (model, variant) {
		...
		return _List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('form-row mt-2')
					]),
				_List_fromArray(
					[
						A2(
						...
						A2(author$project$Page$Voting$showVoteButton, model, variant))
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
									...
									[
										...
										_List_fromArray(
											[
												...
												A2(elm$html$Html$Attributes$style, 'width', percent + '%')
											]),
										_List_fromArray(
											[
		...
		_Utils_ap(
			...
			_Utils_ap(
				elm$core$List$concat(
					A2(
						elm$core$List$map,
						author$project$Page$Voting$showVariant(model),
						model.g)),
	...
	var nonStaticBody = function () {
		switch (model.$) {
			case 2:
				...
				return A2(
					elm$core$List$map,
					elm$html$Html$map(author$project$Main$GotHomeMsg),
					author$project$Page$Home$view(subModel));
			case 3:
				var subModel = model.a;
				return A2(
					elm$core$List$map,
					elm$html$Html$map(author$project$Main$GotVotingMsg),
					author$project$Page$Voting$view(subModel));
			case 4:
				var subModel = model.a;
				return A2(
					elm$core$List$map,
					elm$html$Html$map(author$project$Main$GotNewVotingMsg),
					author$project$Page$NewVoting$view(subModel));
			case 1:
				return _List_fromArray(
					[
						A2(
	...
	return _List_fromArray(
		[
			...
			_Utils_ap(
				...
				_Utils_ap(nonStaticBody, author$project$Main$footerElement)))
		]);
};
var author$project$Main$getTitle = function (model) {
	switch (model.$) {
		case 2:
			return 'Ask to Vote!';
		case 3:
...
var author$project$Main$view = function (model) {
	var realTitle = author$project$Main$getTitle(model);
	return {
		aD: author$project$Main$getBody(model),
		aV: realTitle
	};
};
var elm$browser$Browser$application = _Browser_application;
var author$project$Main$main = elm$browser$Browser$application(
	{aO: author$project$Main$init, aP: author$project$Main$UrlChanged, aQ: author$project$Main$LinkClicked, aU: author$project$Main$subscriptions, aW: author$project$Main$update, aY: author$project$Main$view});
